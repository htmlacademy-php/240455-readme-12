<main class="page__main page__main--publication">
	<div class="container">
		<h1 class="page__title page__title--publication"><?= $page_title; ?></h1>
...
<!-- 											<a class="comments__user-name" href="#"> <span>Лариса Роговая</span> -->
<!-- 											</a> -->
<!-- 											<time class="comments__time" datetime="2019-03-18">2 дня -->
<!-- 												назад</time> -->
<!-- 										</div> -->
<!-- 										<p class="comments__text">Озеро Байкал – огромное древнее -->
<!-- 											озеро в горах Сибири к северу от монгольской границы. Байкал -->
				...
				<div class="post-details__user user">
					<div class="post-details__user-info user__info">
						...
						<div class="post-details__name-wrapper user__name-wrapper">
							...
							<time class="post-details__time user__time" datetime="<?= $user_registration_title; ?>"><?= $user_registration_interval; ?> на сайте</time>
						</div>
					</div>
